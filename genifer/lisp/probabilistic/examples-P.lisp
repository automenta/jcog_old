;;;; ==========================================================
;;;;         Examples for P logic (pure probabilistic)
;;;; ==========================================================

;;;; Genifer/Examples-P.lisp
;;;;
...
;;; where theta is a number in [0,1], with 0.0 and 1.0 corresponding to AND and OR
;;;       c1, c2,... are parameters of the probabilistic AND/OR function
;;;       each literal is associated with one c
